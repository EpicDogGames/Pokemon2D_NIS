...
public class NPCController : MonoBehaviour, Interactable, ISavable
{
    ...
    public object CaptureState()
    {
        ...
        saveData.activeQuest = activeQuest?.GetSaveData();                           // convert to Quest class

        if (questToStart != null)
            saveData.questToStart = (new Quest(questToStart)).GetSaveData();        // convert QuestBase to QuestSaveData
        if (questToComplete != null)
