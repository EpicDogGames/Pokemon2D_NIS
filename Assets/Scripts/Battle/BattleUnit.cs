...
public class BattleUnit : MonoBehaviour
{
    ...
    private void Awake() 
    {
        ...
        originalPos = image.transform.localPosition;   // using localPosition to relate it to the canvas and not its actual position in the world
    ...
    public IEnumerator PlayCaptureAnimation()
    {
        ...
        sequence.Join(transform.DOScale(new Vector3(0.3f, 0.3f, 0.3f), 0.5f));
